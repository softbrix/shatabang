...
config.mongoHost = process.env.MONGO_PORT_27017_TCP_ADDR || config.mongoHost || '127.0.0.1';
config.mongoPort = process.env.MONGO_PORT_27017_TCP_PORT || config.mongoPort || 27017;
